...
class FetchUserFlightInfoInput(BaseModel):
    pass


class FetchUserFlightInfo(BaseTool):
    name: str = "fetch_user_flight_information"
    description: str = "Fetch all tickets for the user along with corresponding flight information and seat " \
                       "assignments. "
    args_schema: Type[BaseModel] = FetchUserFlightInfoInput
...
class UpdateTicket(BaseTool):
    name: str = "update_ticket_to_new_flight"
    ...
    def _run(self, ticket_no: str, new_flight_id: int) -> str:
...
class CancelTicket(BaseTool):
    ...
    def _run(self, ticket_no: str) -> str:
